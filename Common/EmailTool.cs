...
namespace Common
{
    public class EmailTool
    {
        ...
        {
            Common.EmailTool email = new Common.EmailTool(); 

            if (System.Configuration.ConfigurationManager.AppSettings["EmailFrom"] == null)
            {
                email.Address_From = "report@iseedling.com";
            }
            else
            {
                email.Address_From = System.Configuration.ConfigurationManager.AppSettings["EmailFrom"].ToString();
            }
            if (System.Configuration.ConfigurationManager.AppSettings["EmailBcc"] == null)
            {
                email.Bcc = "jack.song@esmartwave.com";
            }
            else
            {
                email.Bcc = System.Configuration.ConfigurationManager.AppSettings["EmailBcc"].ToString();
            } 

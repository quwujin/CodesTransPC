...
<asp:Content ID="cntIndex" runat="server" ContentPlaceHolderID="body">
     <div class="admin-content">
    <iframe frameborder="0" scrolling="yes" id="main" name="mainframe" marginheight="0" marginwidth="0" src="dlist.aspx" width="100%" height="800"></iframe> 
    </div>
<%--        <div class="admin-content">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="am-text-center">
                                                <img src="assets/i/examples/admin-chrome.png" alt=""></td>
                                            <td>Google Chrome</td>
                                            <td>3,005</td>
                                        </tr>
                                        <tr>
                                            <td class="am-text-center">
                                                <img src="assets/i/examples/admin-firefox.png" alt=""></td>
                                            <td>Mozilla Firefox</td>
                                            <td>2,505</td>
                                        </tr>
                                        <tr>
                                            <td class="am-text-center">
                                                <img src="assets/i/examples/admin-ie.png" alt=""></td>
                                            <td>Internet Explorer</td>
                                            <td>1,405</td>
                                        </tr>
                                        <tr>
                                            <td class="am-text-center">
                                                <img src="assets/i/examples/admin-opera.png" alt=""></td>
                                            <td>Opera</td>
                                            <td>4,005</td>
                                        </tr>
                                        <tr>
                                            <td class="am-text-center">
                                                <img src="assets/i/examples/admin-safari.png" alt=""></td>
                                            <td>Safari</td>
                                            <td>505</td>
                                        </tr>
                                    </tbody>
